...
bslib::layout_column_wrap(class = "cards-display",
  ...
  generate_card(committe_list[[10]], class_group =  "card-header-comite"),
  generate_card(committe_list[[11]], class_group =  "card-header-comite"),
  generate_card(committe_list[[12]], class_group =  "card-header-comite"),
  generate_card(committe_list[[13]], class_group =  "card-header-comite")
